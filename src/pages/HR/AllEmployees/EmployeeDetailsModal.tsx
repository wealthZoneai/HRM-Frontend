...
const validationSchema = Yup.object({
    ...
    personal_email: Yup.string().email("Invalid email format").required("Personal Email is required"),
              ...
              <div className="lg:col-span-2 p-6 space-y-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  <InfoCard
                    icon={FiClock}
                    title="Work Type"
                    value={fullData?.employment_type}
                  />
                  <InfoCard
                    icon={FiAward}
                    title="Gender"
                    value={fullData?.gender}
                  />
                  <InfoCard
                    icon={FiFolder}
                    title="Marital Status"
                    value={fullData?.marital_status}
                  />
                  <InfoCard
                    icon={DollarSign}
                    title="Blood Group"
                    value={fullData?.blood_group}
                  />
                </div>
