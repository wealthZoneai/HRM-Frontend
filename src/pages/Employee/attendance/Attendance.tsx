...
export default function Attendance() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h1 className="text-xl md:text-md font-bold text-gray-900">Attendance Overview</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
        ...
        <motion.div
          ...
          className="md:col-span-2 bg-white/70 backdrop-blur-md rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-lg transition-all duration-300"
        >
          <AttendanceTable />
        </motion.div>
      </div>
